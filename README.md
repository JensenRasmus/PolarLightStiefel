...
For practical reasons, one might need to edit the files slightly to either generate data (True/False flags), as well as edit the dimensions. 
In the head of each file in the folder *applications*, it is indicated what figure the script produces data for. The generated .npy files can be used to produce the figures. Copy-paste them into the *figures* folder. 
